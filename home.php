...
<div class="col-lg-3 col-md-2">
    <!--logoo-->
<div class="logo">
<a href="jobSeeker.php"><img src="image/cognate.png" alt="" width="150px"> </a>
</div>  
</div>  
...
<div class="menu-wrapper">
    ...
    <li><a href="Available_jobs.php">Find A Jobs</a></li>
     ...
     <li><a href="areas_of_expetise.php">Areas of Expertise</a></li>
...
<div class="header-btn d-none f-right d-lg-block">
                                  <a href="submit_job.php" class="btn head-btn1">Register</a>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
                      <div class="single-footer-caption mb-50">
                          <div class="footer-tittle">
                              ...
                              <ul>
                                  <li>
                                  <p>Location India:Cognate Global Business Solution Pvt Ltd.
126/4, 1st Cross East End
Palace Cross Road,
Bangalore - 560020
</p>
                                  </li>
                               ...
                               <div id="mc_embed_signup">
                                   ...
                                   method="get" class="subscribe_form relative mail_part">
                                       ...
                                       <div class="form-icon">
                                           ...
                                           class="email_icon newsletter-submit button-contactForm"><img src="image/form.png" alt=""></button>
                                       </div>
  ...
  Cognate Global Business Solution &copy;<script>document.write(new Date().getFullYear());</script>  </a>  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
                           </div>
                       </div>

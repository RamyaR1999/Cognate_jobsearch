...
?>
    ...
    <section class="u-clearfix u-custom-color-2 u-lightbox u-section-1" id="sec-de5a">
        ...
        <div style="background-image: url('images/table2.jpg'); background-repeat:no-repeat; background-size:cover;">
            <div class="u-clearfix u-sheet u-sheet-1">
                <h3 class="u-align-center u-text u-text-default  u-text-1" style="color:#f8002f;"
                    data-animation-name="zoomIn" data-animation-duration="1000" data-animation-delay="0"
                    data-animation-direction="">Find Your Job
                </h3>
                <div class="u-expanded-width-xs u-form u-form-1">
                    <form action="" autocomplete="off" method="POST"
                        class="u-clearfix u-form-custom-backend u-form-horizontal u-form-spacing-2 u-inner-form"
                        style="padding: 15px;" source="custom" redirect="true">
                        <div class="u-form-group u-form-name">
                            <label for="name-ef64" class="u-form-control-hidden u-label"></label>
                            <input type="text" style="color:#f8002f;" placeholder="Enter job title" id="jobtitle"
                                name="Job_title" class="u-input u-input-rectangle u-radius-3 u-white u-input-1">
                        ...
                        <div class="u-form-email u-form-group">
                            ...
                            <input type="text" style="color:#f8002f;" placeholder="Skills" id="Skills" name="Skills"
                                class="u-input u-input-rectangle u-radius-3 u-white u-input-2">
                        </div>
                        <div class="u-form-group u-form-submit">
                            <a href="Available_jobs.php" class="btn head-btn1 " style="padding: 12px"><span
                                    class="u-icon u-text-palette-1-base u-icon-1"><svg class="u-svg-content"
                                        viewBox="0 0 512 512" x="0px" y="0px" style="width: 1em; height: 1em;">
                                        <g>
                                            <path
                                                d="M496.128,220.361l-160-144.032c-19.712-17.728-50.08-16.192-67.808,3.584c-17.728,19.68-16.128,50.048,3.584,67.776    l66.976,60.32H48c-26.528,0-48,21.472-48,48s21.472,48,48,48h290.944l-67.072,60.32c-19.712,17.76-21.312,48.096-3.584,67.776    c9.504,10.528,22.592,15.904,35.712,15.904c11.456,0,22.944-4.064,32.096-12.32l160-143.968    c10.112-9.088,15.904-22.08,15.904-35.68C512,242.441,506.208,229.449,496.128,220.361z">
                                            </path>
                                            <!-- </g> -->
                                        </g>
                                    </svg><img></span>&nbsp;<br>
        ...
        * {
        ...
        <div class="slideshow-container">
            <div class="mySlides fade">
                ...
                <img src="images/jobseekernew1.jpg" style="width: 100%" />
                <div class="text"></div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">2 / 3</div>
                <img src="images/jobseekernew2.jpg" style="width: 100%" />
                <div class="text"></div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">3 / 3</div>
                <img src="images/jobseekernew3.jpg" style="width: 100%" />
                <div class="text"></div>
            </div>
        </div>
        <br />
                    ...
                    <div class="u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-1">
                            <p class="u-text u-text-default u-text-palette-1-base u-text-2">
                                <a class="u-active-none u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-btn u-button-link u-button-style u-hover-none u-none u-text-active-palette-1-base u-text-hover-palette-1-base u-text-palette-1-base u-btn-1"
                                    href="Available_jobs.php" target="_blank">Information technology</a>
                            </p>
                        </div>
                    </div>
                    <div class="u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-2">
                            <p class="u-text u-text-default u-text-palette-1-base u-text-3">
                                <a class="u-active-none u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-btn u-button-link u-button-style u-hover-none u-none u-text-active-palette-1-base u-text-hover-palette-1-base u-text-palette-1-base u-btn-2"
                                    href="Available_jobs.php" target="_blank">banking &amp; finance</a>
                            </p>
                        </div>
                    </div>
                    <div class="u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-3">
                            <p class="u-text u-text-default u-text-palette-1-base u-text-4">
                                <a class="u-active-none u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-btn u-button-link u-button-style u-hover-none u-none u-text-active-palette-1-base u-text-hover-palette-1-base u-text-palette-1-base u-btn-3"
                                    href="Available_jobs.php" target="_blank">Manufacturing</a>
                            </p>
                        </div>
                    </div>
                    <div class="u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-4">
                            <p class="u-text u-text-default u-text-palette-1-base u-text-5">
                                <a class="u-active-none u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-btn u-button-link u-button-style u-hover-none u-none u-text-active-palette-1-base u-text-hover-palette-1-base u-text-palette-1-base u-btn-4"
                                    href="Available_jobs.php" target="_blank">See all jobs</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item active" style="background-image: url('images/jobseekernew11.jpg') ; ">
                    <div class="carousel-caption text-monospace d-none d-md-block">
                        ...
                        <p class="lead text-white">Hiring candidates for a company is a great responsibility.
                            ...
                            This is why the greatest challenge a recruiter faces is how to identify the right
                            talent.
                            It is vital to select the perfect candidate for the required position for various
                            reasons.
                            When an employer fails to recognize the right talent, they are implicating a major loss
                            to
                            themselves.
                            Missing out on the perfect candidate with the right desired talent is an irreversible
                            loss.
                            To help the recruiters in identifying the right talent, here are a few theories by
                            experts.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="right-caption">
                        ...
                        <div class="support-caption">
                            <p class="pera-top">We are one of the largest global HR services firms.<br> We combine
                                our
                            ...
                            <p>Hiring candidates for a company is a great responsibility. The future of the company
                                depends entirely on its employees. This is why the greatest challenge a recruiter
                                faces
                                is how to identify the right talent. It is vital to select the perfect candidate for
                                the
                                required position for various reasons.

                                When an employer fails to recognize the right talent, they are implicating a major
                                loss
                                to themselves. Missing out on the perfect candidate with the right desired talent is
                                an
                                irreversible loss. To help the recruiters in identifying the right talent, here are
                                a
...
<li><a href="Job_seeker.php?page=2">3</a></li></ul> -->
    ...
    <section class="u-clearfix u-custom-color-3 u-lightbox u-section-1" id="sec-de5a">
        <!-- <div style="background: linear-gradient(to right, #0033cc 0%, #ff99ff 100%);">-->
        <div style="background-image: url('images/table11.png'); backgronud-repeat:no-repeat; background-size:cover;">

            <div class="u-clearfix u-sheet u-sheet-1">
                <h3 class="u-align-left u-text u-text-left u-text-1" style="color:#f8002f;" data-animation-name="zoomIn"
                    data-animation-duration="1000" data-animation-delay="0" data-animation-direction="">Find a
                    location.
                </h3>
                <p class="u-align-left u-text u-text-left  u-text-2" style="color:#f8002f;">Drop in and say "hi" at one
                    of our
                    branch locations.</p><br>
                <div class="u-expanded-width-xs u-form u-form-1">
                    <form action="" autocomplete="off" method="POST"
                        class="u-clearfix u-form-custom-backend u-form-horizontal u-form-spacing-2 u-inner-form"
                        style="padding: 15px;" source="custom" redirect="true">
                        <div class="u-form-group u-form-name">
                            ...
                            <input type="text" placeholder="postcode /city"
                                style="width: 2em; color:#f8002f; height: 5em;" id="" minlength="100" maxlength="250"
                                name="Job_title" class="u-input u-input-rectangle u-radius-3 u-white u-input-2">
                            <!--  <input name="Name" id="demoB" type="text" placeholder="Enter job title" class="form-control"> -->
                        </div>
                        <br>
                        <div class="u-form-group u-form-submit">
                            <a href=""
                                class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-1-light-2 u-radius-3 u-white u-btn-1"><span
                                    class="u-icon u-text-palette-1-base u-icon-1"><svg class="u-svg-content"
                                        viewBox="0 0 512 512" x="0px" y="0px"
                                        style="width: 2em; height: 3.5em; color:#f8002f;">
                                        <g>
                                            <path
                                                d="M496.128,220.361l-160-144.032c-19.712-17.728-50.08-16.192-67.808,3.584c-17.728,19.68-16.128,50.048,3.584,67.776    l66.976,60.32H48c-26.528,0-48,21.472-48,48s21.472,48,48,48h290.944l-67.072,60.32c-19.712,17.76-21.312,48.096-3.584,67.776    c9.504,10.528,22.592,15.904,35.712,15.904c11.456,0,22.944-4.064,32.096-12.32l160-143.968    c10.112-9.088,15.904-22.08,15.904-35.68C512,242.441,506.208,229.449,496.128,220.361z">
                                            </path>

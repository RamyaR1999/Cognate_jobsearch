                ...
                <form method="POST" class="my-login-validation">
                    ...
                    <div class="form-group">
                        ...
                        <div style="position:relative" id="">
                            ...
                            <div style="position: absolute; right: 10px; top: 7px; padding: 2px 7px; font-size: 13px; cursor: pointer;"><i class="far fa-eye" id="togglePassword"></i></div>
                        </div>
                        <div class="invalid-feedback">

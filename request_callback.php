...
</li><li class="u-nav-item"><a class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90 active" href="submit-job.php" style="padding: 6px 0px;">Employers</a>
                ...
                <div class="u-container-style u-list-item u-repeater-item">
                  <div class="u-container-layout u-similar-container u-container-layout-2">
                    <p class="u-text u-text-default u-text-2">
                      <a class="u-active-none u-border-2 u-border-active-black u-border-hover-black u-btn u-button-link u-button-style u-hover-none u-none u-text-active-black u-text-black u-text-hover-black u-btn-2" href="submit-job.php">submit a job</a>
                    </p>
                  </div>
                </div>
                <div class="u-container-style u-list-item u-repeater-item">
                ...
                <div class="u-container-style u-list-item u-repeater-item">
                  <div class="u-container-layout u-similar-container u-container-layout-3">
                    <p class="u-text u-text-default u-text-3">
                      <a class="u-active-none u-border-2 u-border-active-black u-border-hover-black u-btn u-button-link u-button-style u-hover-none u-none u-text-active-black u-text-black u-text-hover-black u-btn-3" href="https://nicepage.com">our solutions</a>
                    </p>
                  </div>
                </div>
                <div class="u-container-style u-list-item u-repeater-item">
    ...
    <section class="u-clearfix u-gradient u-section-1" id="sec-6065">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <!-- <div class="card-header bg-transparent border-0"> -->
          <h3 class="mb-0"><i class="far fa-clone pr-1"></i>request a call back</h3>
          <!-- </div> -->
            ...
            <div class="u-layout-row">
               <div class="col-md-12">
                  <div class="input-group">
                     <span style="font-weight: 600;" class="">Firstname: </span><br>
                        <div class="col-sm-12">
                    ...
                    <div class="col-md-12">
                      <div class="input-group">
                        <span style="font-weight: 600;" class="" >Lastname: </span> 
                        <div class="col-sm-12">
                  ...
                  <div class="u-layout-row">
                    <div class="col-md-12">
                      <div class="input-group">
                        <span style="font-weight: 600;" class="">Email: </span> 
                        <div class="col-sm-12">
                    ...
                    <div class="col-md-12">
                      <div class="input-group">
                        <span style="font-weight: 600;" class="">Phone: </span> 
                        <div class="col-sm-12">
                  ...
                  <div class="u-layout-row">
                    <div class="col-md-12">
                      <div class="input-group">
                        <span style="font-weight: 600;" class="" >Designation: </span>
                        <div class="col-sm-12">
                    ...
                    <div class="col-md-12">
                      <div class="input-group">
                        <span style="font-weight: 600;" class="">Company: </span>
                        <div class="col-sm-12">
                  ...
                  <div class="u-layout-row">
                    <div class="col-md-12">
                      <div class="input-group">
                        <span style="font-weight: 600;" class="">Service: </span>
                        <div class="col-sm-12">
                    ...
                    <div class="col-md-12">
                      <div class="input-group">
                         <span style="font-weight: 600;" class="" >Branch: </span>
                        <div class="col-sm-12">

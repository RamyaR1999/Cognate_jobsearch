...
<li class="u-nav-item"><a class="u-button-style u-nav-link" href="Page-2.html" style="padding: 6px 0px;">Page 2</a></li> -->
    ...
    <section class="u-clearfix u-custom-color-1 u-lightbox u-section-1" id="sec-de5a">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-align-left u-text u-text-left u-text-black u-text-6">that job offer<br> 
          may be a <br>
          </h2>
          </div>
    </section>
    ...
    <section class="u-clearfix u-custom-color-1 u-lightbox u-section-1" id="sec-de5a">
      <div class="u-clearfix u-sheet u-sheet-1">
        <br>
        <p class="u-align-right u-text u-text-right u-text-white u-text-2" > Our candidates’ safety during their job search process is our top priority.<br>
         Unfortunately, <br>
         some eager job seekers may accidentally fall victim to popular job scams.<br>
          Our recruitment consultants adhere to a structured process <br>
          to ensure we maintain the highest level of integrity.<br>
          We support people and organisations in realising their true potential. <br>
          As a human forward organization, it is our responsibility to educate <br>
          job seekers and help them understand what a standard job search journey looks like.</p><br>
    ...
    <section class="u-clearfix u-custom-color-3 u-lightbox u-section-1" id="sec-de5a">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <p class="u-align-center u-text u-text-right u-text-white u-text-2" >India does not charge any fee / money at any stage of its recruitment process from the candidate <br>
        nor allows their employees to collect any fees from any candidates.<br>
        We would like to categorically state that these communications<br>
        are purely made by imposters with the intent to cheat the candidates. 
        India has not authorized any individual to acquire any kind of<br>
        payment from candidates, towards our company or towards <br>
        any individual in the recruitment process.<p>
</div>
    </section>
    <section class="u-clearfix u-custom-color-1 u-lightbox u-section-1" id="sec-de5a">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <p class="u-align-left u-text u-text-right u-text-white u-text-2" >all individuals processed by randstad must undergo <br>a formal interview process with randstad and with<br> the companies that randstad represents <br>before they can potentially receive an employment offer.<br> The standard recruitment process includes a formal email<br>
          from a email id, phone communications or face-to-face / virtual meeting between <br>the recruiter and the interviewee to understand <br>personal career aspirations, manage job interview expectations and/or to negotiate salary and benefits.<p><br>

        <p class="u-align-left u-text u-text-right u-text-white u-text-2" >will not be liable or responsible for any activity of such <br>fake recruiters or their false promise for jobs nor<br> for any loss or damage incurred by such <br>candidates who intend to use their services, which they do so at their own risk and costs.</p>
</div>
    </section>
